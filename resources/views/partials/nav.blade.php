...
<thead class="table table-bordered">
    <tr>
        ...
        <th scope="col" class="{{ setActivo('proyectos.index') }} {{ setActivo('proyectos.show') }}"><a href="{{ route('proyectos.index') }}">Proyectos</a></th>
        <th scope="col" class="{{ setActivo('clientes.index') }} {{ setActivo('clientes.show') }}"><a href="{{ route('clientes.index') }}">Clientes</a></th>
