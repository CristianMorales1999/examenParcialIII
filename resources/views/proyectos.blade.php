...
<div class="space-y-6">
    ...
    @if(!$proyectos->isEmpty())
        ...
        <!-- Pagination -->
        @include('partials.pagination', ['paginator' => $proyectos])
    @else
        <!-- Empty State -->
        <div class="text-center py-12">
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-2">No hay proyectos registrados</h3>
            <p class="text-gray-500 mb-6">Comienza registrando tu primer proyecto para gestionar tus trabajos.</p>
            <a href="{{ route('proyectos.create') }}" 
               class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 active:bg-green-900 focus:outline-none focus:border-green-900 focus:ring ring-green-300 disabled:opacity-25 transition ease-in-out duration-150">
                <i class="fas fa-plus mr-2"></i>
